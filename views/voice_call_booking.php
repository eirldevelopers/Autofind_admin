...
<?php include_once(__DIR__ ."/../models/voicecallbookingfunctions.php"); ?>
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                $res = VoiceCallBookingFunctions::get_voice_call_booking();
                                $opu_res = VoiceCallBookingFunctions::get_opration_user();
